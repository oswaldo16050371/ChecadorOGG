...
<html>
  <head>
   ...
   <title>TMM | Admin</title>
    ...
    <link rel="shortcut icon" href="../public/img/mm.png">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>TMM</b> A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>TMM</b> ADMIN</span>
    </a>
...
?>
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>CATALOGOS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="usuario.php"><i class="fa fa-circle-o"></i> PERSONAL</a></li>
            <li><a href="tipousuario.php"><i class="fa fa-circle-o"></i> Tipo PERSONAL</a></li>
